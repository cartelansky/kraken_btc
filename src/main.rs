...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut file = File::create("kraken_btc_markets.txt")?;
    for coin in &coins {
        writeln!(file, "{}", coin)?;
    }

    println!("Kraken BTC spot piyasası coin listesi başarıyla oluşturuldu ve kaydedildi.");
